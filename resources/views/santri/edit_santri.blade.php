            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form" method="POST" action="{{ route('update.santri', $santri->id) }}">
                            @csrf
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_wali" class="form-control"
                                            name="nama_wali" value="{{ old('nama_wali', $santri->nama_wali) }}" placeholder="Nama Wali" required>
                                        @error('nama_wali')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="np_hp_wali" class="form-control"
                                            name="no_hp_wali" value="{{ old('no_hp_wali', $santri->no_hp_wali) }}" placeholder="No HP Wali" required>
                                        @error('no_hp_wali')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="alamat" class="form-control"
                                            name="alamat" placeholder="Alamat" required>{{ old('alamat', $santri->alamat) }}</textarea>
                                        @error('alamat')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
