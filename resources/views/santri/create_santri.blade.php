        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="POST" action="{{ route('store.santri') }}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="jumlah_saudara" class="form-control"
                                            placeholder="Jumlah Saudara" name="jumlah_saudara" value="{{ old('jumlah_saudara') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="anak_ke" class="form-control"
                                            placeholder="Anak Ke" name="anak_ke" value="{{ old('anak_ke') }}" required>
                                        @error('anak_ke')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="asal_sekolah" class="form-control"
                                            placeholder="Asal Sekolah" name="asal_sekolah" value="{{ old('asal_sekolah') }}" required>
                                        @error('asal_sekolah')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_ayah" class="form-control"
                                            placeholder="Nama Ayah" name="nama_ayah" value="{{ old('nama_ayah') }}" required>
                                        @error('nama_ayah')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_ibu" class="form-control"
                                            placeholder="Nama Ibu" name="nama_ibu" value="{{ old('nama_ibu') }}" required>
                                        @error('nama_ibu')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pekerjaan_ayah" class="form-control"
                                            placeholder="Pekerjaan Ayah" name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pekerjaan_ibu" class="form-control"
                                            placeholder="Pekerjaan Ibu" name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}" required>
                                        @error('pekerjaan_ibu')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="penghasilan_ayah" class="form-control"
                                            placeholder="Penghasilan Ayah" name="penghasilan_ayah" value="{{ old('penghasilan_ayah') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="penghasilan_ibu" class="form-control"
                                            placeholder="Penghasilan Ibu" name="penghasilan_ibu" value="{{ old('penghasilan_ibu') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="alamat_ortu" class="form-control"
                                            name="alamat_ortu" placeholder="Alamat Orang Tua" required>{{ old('alamat_ortu') }}</textarea>
                                        @error('alamat_ortu')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama_wali" class="form-control"
                                            placeholder="Nama Wali" name="nama_wali" value="{{ old('nama_wali') }}" required>
                                        @error('nama_wali')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pekerjaan_wali" class="form-control"
                                            placeholder="Pekerjaan Wali" name="pekerjaan_wali" value="{{ old('pekerjaan_wali') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="penghasilan_wali" class="form-control"
                                            placeholder="Penghasilan Wali" name="penghasilan_wali" value="{{ old('penghasilan_wali') }}" required>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="no_hp_wali " class="form-control"
                                            name="no_hp_wali" placeholder="No Wa Aktif " required>{{ old('no_hp_wali') }}</textarea>
                                        @error('no_hp_wali ')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="alamat_wali" class="form-control"
                                            name="alamat_wali" placeholder="Alamat Wali" required>{{ old('alamat_wali') }}</textarea>
                                        @error('alamat_wali')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
